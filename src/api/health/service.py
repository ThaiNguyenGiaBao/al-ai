...
PROMPT = (
    ...
    '"analysis_vn": object chứa các trường mô tả kết luận và khuyến nghị bằng TIẾNG VIỆT:\n'
...
class HealthService:
    ...
    def detect_from_url(self, image_url: str) -> Dict[str, Any]:
        ...
        return self._detect(image_bytes)
    ...
    def _detect(self, image_bytes: bytes) -> Dict[str, Any]:
        """
        Call model, return analysis.
        """
        return geminiModel.generate_json_response(image_bytes, PROMPT)
